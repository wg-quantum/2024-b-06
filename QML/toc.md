...
量子ニューラルネットワークについて、パラメーターチューニングの手法について研究を行いました。研究成果については、[報告資料](../2024-B-06-final-report-quantum-computing.pdf)をご覧ください。ソースコードをこちらで紹介します。



## 量子機械学習 コード一覧

- [量子機械学習（VQC）と古典機械学習（SVM）の比較検証](./adrian_vqc_src/run_exper_vqc.ipynb)
